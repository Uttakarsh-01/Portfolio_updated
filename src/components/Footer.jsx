            ...
            >
                <p className="text-white text-xl mb-4">
                    Developed with <motion.span 
                        ...
                        ❤
                    </motion.span> by Uttakarsh
                </p>
                
                <div className="flex justify-center space-x-6 text-white mb-6">
                <a href="https://www.linkedin.com/in/uttakarsh-pratap-singh/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaLinkedin>
              </a>
              <a href="https://leetcode.com/u/Uttakarsh_01/" target="_blank" rel="noopener noreferrer"> 
                ...
                <a href="https://www.instagram.com/uttakarsh_ig01/" target="_blank" rel="noopener noreferrer"> 
                <FaInstagram className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaInstagram></a>
                <a href="https://github.com/uttakarsh-01" target="_blank" rel="noopener noreferrer"> 
                <FaGithub className='text-white transition ease-in-out delay-100 hover:-translate-y-1' size={24}></FaGithub> </a>
                <a href="https://x.com/uttakarsh_01" target="_blank" rel="noopener noreferrer"> 
                ...
                <p className="text-white text-sm">
                    © {currentYear} Uttakarsh Singh. All Rights Reserved.
                </p>
            </motion.div>
        </footer>
    );
